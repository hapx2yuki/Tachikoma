...
inline int fakeI2sInstallResult=ESP_OK, fakeI2sPinResult=ESP_OK;
inline i2s_pin_config_t i2sPins{};
inline int i2s_driver_install(int,i2s_config_t* cfg,int,void*){i2sConfig=*cfg;return fakeI2sInstallResult;}
inline int i2s_driver_uninstall(int){return ESP_OK;}
inline int i2s_set_pin(int,i2s_pin_config_t* pins){if (pins) i2sPins=*pins;return fakeI2sPinResult;}
inline int i2s_zero_dma_buffer(int){return ESP_OK;}
