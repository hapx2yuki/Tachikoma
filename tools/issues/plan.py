...
| 案 | 効果 | 条件・コスト |
|---|---|---|
| A. UBEC 出力 7.4V | +15〜20% トルク | **実サーボの許容電圧を一次資料で確認** (DS3218 は 6.8V 上限。Hiwonder LD-20MG/LD-220MG は要確認)。MG90S 側は別レール |
| B. 高トルク品 (25〜35 kgf·cm 級, 同寸法 40×20) | +25〜75% | 追加購入 12〜14 本。ケース寸法が同じなら STL 無変更 |
| C. 低トルク歩容: `STANCE_R 129→122` + `MAX_STEP 30→26` | 18.5→17.0 (-8%) | firmware/config 定数のみ。歩幅 -13%、安定マージン +8.7mm に低下 (sim_gait 2026-09-04 グリッド) |
| D. 軽量化 (Cabin を薄壁/低インフィルで再印刷, 電装整理) | 質量に比例 | Cabin 534g が最大。-100g で -3% |
